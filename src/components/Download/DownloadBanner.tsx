...
const DownloadBanner: React.FC = (): JSX.Element => {
  return (
    <div>
      <ul className="relative z-10 mx-auto mt-10 grid max-w-screen-2xl grid-cols-1 gap-4 px-4 max-lg:grid-rows-4 sm:mt-16 lg:grid-cols-2 lg:px-6">
        <li className="flex h-full flex-col gap-10 rounded-2xl bg-dark-layer-01 bg-opacity-70 p-4">
          <div>
            ...
            >
              ...
              <g>
                <path
                  d="M34 17.0622L37.5 11"
                  stroke="white"
                  strokeLinecap="round"
                />
                <path
                  d="M8 11L11.5 17.0622"
                  stroke="white"
                  strokeLinecap="round"
                />
              </g>
          ...
          <div className="mt-auto flex w-full gap-2 max-[500px]:flex-col">
            ...
            <Link
              className="inline-flex  items-center px-4  font-sans text-body-compact-01 rounded-lg ring-inset  focus:ring-1 focus:ring-offset-2 normal-case disabled:text-light-text-disabled  gap-2 disabled:cursor-not-allowed disabled:pointer-events-none ring-light-focus-inset ring-offset-light-focus-border disabled:bg-light-button-disabled theme-dark:ring-dark-focus-inset theme-dark:ring-offset-dark-focus-border theme-dark:disabled:bg-dark-button-disabled text-light-text-on-color bg-light-button-primary hover:bg-[rgb(0,79,193)] active:bg-light-button-primary-active disabled:text-light-text-disabled disabled:bg-light-button-disabled theme-dark:text-dark-text-on-color theme-dark:bg-dark-button-primary theme-dark:hover:bg-dark-button-primary-hover theme-dark:active:bg-dark-button-primary-active theme-dark:disabled:text-dark-text-disabled theme-dark:disabled:bg-dark-button-disabled py-[0.6875rem] justify-between w-full theme-dark"
              href={
                "https://play.google.com/store/apps/details?id=tm.belet.films"
              }
            >
