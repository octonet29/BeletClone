...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[9999] p-4">
      ...
      {isOpen && (
        <div className="flex justify-center gap-0.5 rounded-[0.625rem] p-0.5 pl-3.5 group-data-[menu-open='true']:w-full group-data-[menu-open='true']:justify-between  max-sm:w-full max-sm:justify-between [&>span]:hidden">
